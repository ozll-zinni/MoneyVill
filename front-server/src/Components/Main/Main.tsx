...
function Main(): JSX.Element {
  ...
  const { data: getAdmin } = useGetAdminUserCheckQuery('');
            ...
            <div className="w-[36%] h-full">
              ...
              <div className="flex justify-end h-[7%] w-full">
                <img
                  aria-label="믹스2"
                  className="z-10 h-full"
                  src={'/images/toys/mixassets2.png'}
                  alt=""
                />
              </div>
            </div>
